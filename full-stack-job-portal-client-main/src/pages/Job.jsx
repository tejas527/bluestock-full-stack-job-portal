            ...
            <Wrapper>
                ...
                <div className="middle-row">
                    ...
                    <h4 className="deadline">
                        Deadline: <span className="">{dayjs(job?.job_deadline).format("MMM Do, YYYY")}</span>
                    </h4>
                    <h4 className="vacancy">
                        Job Vacancy: <span className="">{job?.job_vacancy}</span>
                    </h4>
                    ...
                    <h4 className="salary">
                        Salary: <span className="">{job?.job_salary} TK</span>
                    </h4>
                    <div className="apply">
                        <h3 className="sec-title">To apply</h3>

                        <p className="intro">send your cv/resume</p>
                        <p className="info">Email: {job?.job_contact}</p>
                    </div>
                </div>
            </Wrapper>
        </>
